...
{{/*
Default image settings (used when values are empty/overridden with empty strings)
*/}}
{{- define "agent-operator.imageRepositoryDefault" -}}
europe-docker.pkg.dev/severalnines-public/clustercontrol/kuber-agent
{{- end -}}
